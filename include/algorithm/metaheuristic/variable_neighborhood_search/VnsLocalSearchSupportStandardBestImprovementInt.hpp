#ifndef UO_ALGORITHM_VNS_LOCAL_SEARCH_SUPPORT_STANDARD_BI_INT_HPP
#define UO_ALGORITHM_VNS_LOCAL_SEARCH_SUPPORT_STANDARD_BI_INT_HPP
...
/**
 * @brief Best Improvement local search for Int solutions in VNS.
 */
class VnsLocalSearchSupportStandardBestImprovementInt : public VnsLocalSearchSupport {
public:
...
#endif // UO_ALGORITHM_VNS_LOCAL_SEARCH_SUPPORT_STANDARD_BI_INT_HPP
